...
* Overall Life Table                                                           ;
  %IF &TABLE='OVERALL' %THEN %DO;
    %HAZPRED(
    PROC HAZPRED DATA=&IN INHAZ=USLIFE84.HZICALL OUT=&OUT NOCL NONOTES;
         TIME AGE;);
    DATA &OUT; SET &OUT;
    AGESURV=_SURVIV;
...
* Females                                                                      ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=FEMALE INHAZ=USLIFE84.HZICF OUT=FEMALE NOCL NONOTES;
         TIME AGE;);
    %END;
* Males                                                                        ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=MALE INHAZ=USLIFE84.HZICM OUT=MALE NOCL NONOTES;
         TIME AGE;);
    %END;
...
* Whites                                                                       ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=WHITE INHAZ=USLIFE84.HZICW OUT=WHITE NOCL NONOTES;
         TIME AGE;);
    %END;
* Other races                                                                  ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=OTHER INHAZ=USLIFE84.HZICO OUT=OTHER NOCL NONOTES;
         TIME AGE;);
    %END;
...
* White males                                                                  ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=WM INHAZ=USLIFE84.HZICWM OUT=WM NOCL NONOTES;
         TIME AGE;);
    %END;
* Other males                                                                  ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=OM INHAZ=USLIFE84.HZICOM OUT=OM NOCL NONOTES;
         TIME AGE;);
    %END;
* White females                                                                ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=WF INHAZ=USLIFE84.HZICWF OUT=WF NOCL NONOTES;
         TIME AGE;);
    %END;
* Other females                                                                ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=OF INHAZ=USLIFE84.HZICOF OUT=OF NOCL NONOTES;
         TIME AGE;);
    %END;
...
* Overall Life Table                                                           ;
  %IF &TABLE='OVERALL' %THEN %DO;
    %HAZPRED(
    PROC HAZPRED DATA=&OUT INHAZ=USLIFE84.HZICALL OUT=&OUT NOCL NONOTES; TIME AGE_YR;);
    DATA &OUT; SET &OUT;
