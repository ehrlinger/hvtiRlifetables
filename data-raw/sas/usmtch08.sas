*******************************************************************************;
* US Life Table 2008                                                          ;
  %MACRO usmtch08(IN=IN, OUT=OUT, TABLE='SEXRACE', INDIVIDL=0, ID=STUDY,
...
*______________________________________________________________________________;
*                                                                              ;
  LIBNAME USLIFE08 '/studies/general/uslife/table2008/estimates';
*******************************************************************************;
* Overall Life Table                                                           ;
  %IF &TABLE='OVERALL' %THEN %DO;
    %HAZPRED(
    PROC HAZPRED DATA=&IN INHAZ=USLIFE08.HZICALL OUT=&OUT NOCL NONOTES;
         TIME AGE;);
    DATA &OUT; SET &OUT;
    AGESURV=_SURVIV;
...
* Females                                                                      ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=FEMALE INHAZ=USLIFE08.HZICF OUT=FEMALE NOCL NONOTES;
         TIME AGE;);
    %END;
* Males                                                                        ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=MALE INHAZ=USLIFE08.HZICM OUT=MALE NOCL NONOTES;
         TIME AGE;);
    %END;
...
* Whites                                                                       ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=WHITE INHAZ=USLIFE08.HZICW OUT=WHITE NOCL NONOTES;
         TIME AGE;);
    %END;
* Other races: here we use estimate of black race as estimate for other race ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=OTHER INHAZ=USLIFE08.HZICB OUT=OTHER NOCL NONOTES;
         TIME AGE;);
    %END;
...
* White males                                                                  ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=WM INHAZ=USLIFE08.HZICWM OUT=WM NOCL NONOTES;
         TIME AGE;);
    %END;
* Other males                                                                  ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=OM INHAZ=USLIFE08.HZICBM OUT=OM NOCL NONOTES;
         TIME AGE;);
    %END;
* White females                                                                ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=WF INHAZ=USLIFE08.HZICWF OUT=WF NOCL NONOTES;
         TIME AGE;);
    %END;
* Other females                                                                ;
    ...
    %IF &_NUM_>0 %THEN %DO;
      %HAZPRED(
      PROC HAZPRED DATA=OF INHAZ=USLIFE08.HZICBF OUT=OF NOCL NONOTES;
         TIME AGE;);
    %END;
...
* Overall Life Table                                                           ;
  %IF &TABLE='OVERALL' %THEN %DO;
    %HAZPRED(
    PROC HAZPRED DATA=&OUT INHAZ=USLIFE08.HZICALL OUT=&OUT NOCL NONOTES; TIME AGE_YR;);
    DATA &OUT; SET &OUT;
